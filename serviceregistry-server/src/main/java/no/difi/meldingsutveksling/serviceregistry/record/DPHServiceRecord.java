...
public class DPHServiceRecord extends ServiceRecord {
    ...
    public DPHServiceRecord(){
        super();
    }

    public DPHServiceRecord(ServiceIdentifier serviceIdentifier, String organisationNumber, String process, String endpointUrl, String herIdLevel1, String herIdLevel2, Patient patient) {
