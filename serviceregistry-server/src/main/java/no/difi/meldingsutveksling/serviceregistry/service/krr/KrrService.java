...
public class KrrService {
    ...
    @SneakyThrows
    public KrrService(ServiceregistryProperties srProps, ResourceServerProperties resourceServerProperties) {
        URL jwkUrl = new URL(resourceServerProperties.getJwk().getKeySetUri());
